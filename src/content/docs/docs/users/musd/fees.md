...
The MUSD system fees are split between the [MUSD](https://mezo.org/feature/musd) treasury stability pool (which covers liquidations and bad debt). The initial portion is 50/50, but this is subject to change based on the MUSD splitter. 
